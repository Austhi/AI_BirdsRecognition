...
# train
history = model.fit(trainGenerator, validation_data=validGenerator, epochs=50, callbacks=[lr_scheduler, mAP_callback, early_stopping])


# saving the model
modelSavedPath = "C:/Users/admin/Downloads/Bird_Dataset/dataset_for_model/model_mobileNetV3.keras"
